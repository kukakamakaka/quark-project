    ...
    return (
        ...
        <span className="text-white">
            ...
            your web building experience
                ...
                {/* Bento Grid */}
                <div className="flex overflow-x-auto md:grid md:grid-cols-6 gap-6 pt-12 -mt-10 pb-12 md:pb-6 scrollbar-hide snap-x snap-mandatory px-4 md:px-0">
                        ...
                        >
                            ...
                            <div className="relative z-30 flex flex-col h-full">
                                <div className="relative inline-flex items-center group/badge overflow-hidden rounded-full p-[1.2px] isolate mb-8 self-start">
                                    ...
                                    <div className="relative px-5 py-1.5 rounded-full border border-white/10 bg-black/60 backdrop-blur-2xl flex items-center gap-2.5">
                                        <div className="relative w-1.5 h-1.5 rounded-full bg-fuchsia-500 shadow-[0_0_10px_#d946ef]" />
                                        <span className="relative z-10 text-[10px] font-montserrat font-bold uppercase tracking-[0.3em] bg-gradient-to-b from-fuchsia-300 to-fuchsia-400 bg-clip-text text-transparent">
                            Core Logic
                        </span>
                                    </div>
                                </div>

                                <h3 className="text-[32px] md:text-[52px] font-montserrat font-bold text-white tracking-tight leading-[1.1] mb-6">
                                    AI-Powered <br />
                                    <span className="text-white/20 group-hover:text-white transition-colors duration-700">Design Flow</span>
                                </h3>

                                <p className="text-white/30 max-w-[340px] text-[17px] leading-relaxed group-hover:text-white/50 transition-colors duration-700">
                                    Intelligent suggestions that adapt to your unique style and brand identity flawlessly.
                                </p>
                            </div>

                            <div className="absolute inset-0 z-10 pointer-events-none">
                                <div className="absolute inset-0 z-20 bg-[radial-gradient(circle_at_bottom_right,#00000000_10%,#000000_75%)]" />
                                <motion.div
                            ...
                            <div className="absolute bottom-[-100px] right-[-100px] w-[500px] h-[500px] bg-fuchsia-600/10 blur-[120px] rounded-full z-5 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
                        </motion.div>
                    </div>
                    ...
                    <div className="min-w-[82vw] md:min-w-0 md:col-span-3 h-[380px] md:h-[520px] snap-center group">
                        <motion.div
                            whileHover={{ y: -12 }} // Мынау еркін көтеріледі
                            transition={{ type: "spring", stiffness: 300, damping: 25 }}
                            className="relative w-full h-full rounded-[32px] md:rounded-[40px] bg-black border border-white/[0.05] overflow-hidden p-6 md:p-12 cursor-pointer"
                        >
                            <div className="absolute inset-0 bg-black z-0" />
                        ...
                        Advantages
                            ...
                            <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-[#3B82F6]/10 blur-[100px] rounded-full z-5 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
                        </motion.div>
                    </div>


                    {/* Card 3 */}
                    <div className="min-w-[85vw] md:min-w-full md:col-span-2 h-[380px] md:h-[420px] snap-center group">
                        <motion.div
                            whileHover={{ y: -10 }}
                            transition={{ type: "spring", stiffness: 300, damping: 25 }}
                            className="relative w-full h-full rounded-[24px] md:rounded-[32px] bg-black border border-white/[0.08] overflow-hidden p-6 md:p-8 cursor-pointer"
                        >
                            <div className="absolute inset-0 bg-black z-0" />
                        ...
                        Key Metrics
                                ...
                                <h3 className="text-2xl md:text-3xl font-montserrat font-bold text-white tracking-tight mb-2 drop-shadow-lg">
                                    SEO Tools <br />
                            ...
                            <div className="absolute inset-0 z-10 pointer-events-none">
                                <div className="absolute inset-0 z-20 pointer-events-none bg-[radial-gradient(circle_at_60%_60%,transparent_40%,#000000_95%)]" />
                            ...
                            <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-cyan-400/20 blur-[100px] rounded-full z-5 opacity-40 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
                        </motion.div>
                    </div>
                    ...
                    <div className="min-w-[85vw] md:min-w-full md:col-span-2 h-[380px] md:h-[420px] snap-center group">
                        ...
                        Ecosystem
                            ...
                            <div className="absolute inset-0 z-10 pointer-events-none">
                                <div className="absolute inset-0 z-20 pointer-events-none bg-[radial-gradient(circle_at_center,transparent_20%,#000000_90%)]" />
                            ...
                            <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-blue-500/10 blur-[100px] rounded-full z-5 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
                        </motion.div>
                    </div>
                    ...
                    <div className="min-w-[85vw] md:min-w-full md:col-span-2 h-[380px] md:h-[420px] snap-center group">
                        ...
                        Adaptability
                            ...
                            <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-purple-600/10 blur-[100px] rounded-full z-5 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
                        </motion.div>
                    </div>
